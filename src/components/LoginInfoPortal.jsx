...
export default function LoginInfoPortal({ isOpen, onClose, view }) {
    ...
    return (
        ...
        >
            <div
                className={`relative w-full ${isPresentation ? 'max-w-[1200px] h-[90vh]' : 'max-w-4xl max-h-[95vh]'} overflow-hidden bg-black border border-[#00ff41]/30 rounded-xl flex flex-col shadow-[0_0_30px_rgba(0,255,65,0.1)] transition-all duration-300`}
